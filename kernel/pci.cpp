...
namespace {
    ...
    * もし PCI-PCI ブリッジなら、セカンダリバスに大使、ScanBus を実行する
    */
    ...
    *
    * @param dev MSI ケーパビリティを読み込む PCIデバイス
    ...
    */
    ...
    /** @brief 指定された MSIケーパビリティ構造に書き込む
    *
    * @param dev MSI capability を読み込む PCIデバイス
    * @param cap_addr MSI capability register のコンフィグレーション空間アドレス
    * @param msi_cap 書き込む値
    */
